...
<ScrollView>
    ...
    <View style={styles.header}>
        ...
        <TextInput style={styles.DescInput} 
             ...
             value={formData.desc}
              onChangeText={(text) =>{
                const regex = /[\u{1F600}-\u{1F64F}\u{1F300}-\u{1F5FF}\u{1F680}-\u{1F6FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{1F900}-\u{1F9FF}\u{1F1E0}-\u{1F1FF}\u{1FAD0}-\u{1FAFF}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F300}-\u{1F5FF}\u{1F900}-\u{1F9FF}\u{1F1E6}-\u{1F1FF}\u{1F1F2}-\u{1F1F4}\u{1F1E7}-\u{1F1EC}\u{1F1ED}-\u{1F1EF}\u{1F1F0}-\u{1F1F3}\u{1F1F5}-\u{1F1F7}\u{1F1FA}-\u{1F1FF}]/gu;
